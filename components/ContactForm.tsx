...
export function ContactForm() {
  ...
  return (
    ...
    >
      ...
      {/* Status Messages */}
      {status === "success" && (
        <div className="flex items-center gap-3 rounded-xl border border-green-500/30 bg-green-500/10 px-5 py-3.5 text-sm text-green-400 font-mono animate-in fade-in slide-in-from-bottom-2 duration-300">
      ...
      {status === "error" && (
        <div className="flex items-center gap-3 rounded-xl border border-red-500/30 bg-red-500/10 px-5 py-3.5 text-sm text-red-400 font-mono animate-in fade-in slide-in-from-bottom-2 duration-300">
